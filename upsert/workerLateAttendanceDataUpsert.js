...
module.exports = (db) => {
    ...
    const lateAttendanceCollection =
        db.collection("lateAttendance");
    ...
    const ensureIndex = async () => {
        ...
        try {
            ...
            await lateAttendanceCollection.createIndex(
                {
                    workerId: 1,
                    date: 1,
                },
            ...
            console.log(
                "📌 lateAttendanceCollection index ready"
            );
    ...
    const watchDir = path.join(
        __dirname,
        "../All_ExcelSheet_Of_Worker/Late_ExcelSheet_Of_Worker"
    );
    ...
    const processFile = async (
        ...
        try {
            ...
            for (
                ...
                await lateAttendanceCollection.bulkWrite(
                    chunk,
                    {
                        ordered: false,
                    }
    ...
    const startWatcher = () => {
        ...
        console.log(
            "👀 Auto lateAttendanceCollection System Started..."
        );
